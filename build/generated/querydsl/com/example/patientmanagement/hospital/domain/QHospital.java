...
public class QHospital extends EntityPathBase<Hospital> {
    ...
    private static final long serialVersionUID = 1891961671L;

    public static final QHospital hospital = new QHospital("hospital");

    public final StringPath hospitalDirector = createString("hospitalDirector");

    public final StringPath hospitalName = createString("hospitalName");

    public final NumberPath<Long> id = createNumber("id", Long.class);

    public final StringPath nursingHomeNumber = createString("nursingHomeNumber");
